...
class Rules {
  ...
  getRule() {
    if (this.card1.isSpecial == false && this.card2.isSpecial == false) {
      if (this.card1.color != this.card2.color && this.card1.value != this.card2.value) return 0;
      else return 1;
    } else if (this.card1.isSpecial == true && this.card2.isSpecial == false) {
      if (this.currentColor != this.card2.color) return 0;
      else return 1;
      ...
      if (this.card2.color == "black") {
        ...
        if (this.card1.color != this.card2.color ) return 0;
        else {
      ...
      if (this.card2.color != "black" && this.currentColor != this.card2.color && this.card1.value != this.card2.value) return 0;
      if (this.card2.color == "black") {
        if (this.card2.value == 1) return 6;
        else return 5;
      } else {
