...
function chooseHostOrJoin() {
  ...
  modalHostClose.click(() => {
    ...
    showGameId.className =
      "btn-floating btn-large waves-effect waves-light teal";
    ...
    cardsDoc.forEach((card) => {
      card.addEventListener(methodClick, (e) => {
        let data = {
          ...
          card: {
            isSpecial:
              e.target.attributes.isSpecial.value == "1" ? true : false,
